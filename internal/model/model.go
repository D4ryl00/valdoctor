...
const (
	...
	EventPeerConfigError        EventKind = "peer_config_error"
	EventConsensusWALIssue      EventKind = "consensus_wal_issue"
	...
	EventSignVoteError          EventKind = "sign_vote_error"
	EventSignProposalError      EventKind = "sign_proposal_error"
